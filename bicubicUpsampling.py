...
dataset = load_images_from_folder("/Users/ashi_mac/Desktop/DIV2K_valid_LR_bicubic/X4")
i = 0
for image in dataset:
    output = bicubic(image, ratio, a)
    cv2.imwrite(f"outputs/bicubic/{i}.png",output)
    #output.save(f"outputs/bicubic/{i}.png")
    i += 1
